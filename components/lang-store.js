...
const translations = {
  mn: {
    ...
    accAddress: "Хаяг",
    accContactInfo: "Холбоо барих",
    accEditField: "Засах",
    accSave: "Хадгалах",
    accCancel: "Цуцлах",
    accAddPhone: "Утасны дугаар нэмэх",
    accAddAddress: "Хаяг нэмэх",
    accPhonePlaceholder: "Жишээ: 9911 2233",
    accPhoneHint: "8 оронтой дугаар оруулна уу",
    accAddressPlaceholder: "Хот, дүүрэг, хороо, байр",
    accProfileUpdated: "Мэдээлэл амжилттай шинэчлэгдлээ",
    loginTitle: "Нэвтрэх",
    ...
    editPhone: "Утас",
    editAddress: "Хаяг",
    editNamePlaceholder: "Нэрээ оруулна уу",
    editEmailPlaceholder: "Имэйл хаягаа оруулна уу",
    editPhonePlaceholder: "Утасны дугаараа оруулна уу",
    editAddressPlaceholder: "Хаягаа оруулна уу",
    editCancel: "Болих",
    editSave: "Хадгалах",
    editSaving: "Хадгалж байна...",
  ...
  en: {
    ...
    accAddress: "Address",
    accContactInfo: "Contact info",
    accEditField: "Edit",
    accSave: "Save",
    accCancel: "Cancel",
    accAddPhone: "Add phone number",
    accAddAddress: "Add address",
    accPhonePlaceholder: "e.g. 9911 2233",
    accPhoneHint: "Enter 8-digit number",
    accAddressPlaceholder: "City, district, khoroo, building",
    accProfileUpdated: "Profile updated successfully",
    loginTitle: "Login",
    ...
    editPhonePlaceholder: "Enter your phone number",
    editAddressPlaceholder: "Enter your address",
    editCancel: "Cancel",
